<section id="formulario">
  <div class="container">
    <div class="container">
      <div class="margenx1 fondo_azul py-4 pb-2 rounded">
        ...
        <div class="col-12">
          <div class="row ">
            ...
            <div class="col-12 col-md-6 col-lg-3 col-xl-3 form-group">
              <input placeholder="Precio Mínimo" type="number" class="form-control" id="precio_minimo_buscar" aria-describedby="emailHelp">
            </div>

            <div class="col-12 col-md-6 col-lg-3 col-xl-3 form-group">
              <input placeholder="Precio Máximo" type="number" class="form-control" id="precio_maximo_buscar" aria-describedby="emailHelp">
            </div>

            <div class="col-12 col-md-6 col-lg-3 col-xl-3 form-group">
              <input placeholder="Área Mínima" type="number" class="form-control" id="area_minima_buscar" aria-describedby="emailHelp">
            </div>

            <div class="col-12 col-md-6 col-lg-3 col-xl-3 form-group">
              <input placeholder="Área Máxima" type="number" class="form-control" id="area_maxima_buscar" aria-describedby="emailHelp">
            </div>
            ...
            <div class="col-12 d-flex justify-content-center"><button type="submit" id="buscar" class="btn boton_buscar_formulario"> Buscar </button></div>
